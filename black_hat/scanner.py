...
def udp_sender(subnet, magic_message):
    ...
    # time.sleep(1)
    # print 'send'
    # # pyping.ping("192.168.102.104")
    # sender.sendto(magic_message, ("192.168.102.104", 65212))
...
def sniffering():
    try:
        while True:
            ...
            # print (sniffer.recvfrom(65565)[1])
            ...
            # print 'receive:%d   ip len:%d   protocol:%s'%(len(raw_buffer),ip_header.length,ip_header.protocol_num)
...
# t2 = threading.Thread(target=sniffering)
